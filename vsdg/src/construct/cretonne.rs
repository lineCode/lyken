...
use cretonne_codegen::ir::instructions::{InstructionData, InstructionFormat};
use cretonne_codegen::ir::{self, FuncRef, Heap, MemFlags, Opcode, TrapCode, Value, ValueDef};
